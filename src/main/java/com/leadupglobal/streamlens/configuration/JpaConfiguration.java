package com.leadupglobal.streamlens.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.leadupglobal.streamlens.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.leadupglobal.streamlens.model" });
